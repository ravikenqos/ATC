...
class ut_portfolio_shortcode {
        ...
        $css  = '<style id="ut-portfolio-custom-css-' . self::$token . '" type="text/css" scoped>';
			...
			if( !empty( $custom_settings['filter_font_weight'] ) ) {
		 	...
		 	if( !empty( $custom_settings['filter_text_transform'] ) ) {
                $css .= '.ut-portfolio-' . self::$token . ' .ut-portfolio-menu li a { text-transform: ' . $custom_settings['filter_text_transform'] . ' ; }';
            } else {
    ...
    */
    static function create_responsive_css( $gallery_options ) {
		...
		$desktop_medium_base_height = !empty( $gallery_options['desktop_medium_base_height'] ) ? $gallery_options['desktop_medium_base_height'] : '400';
		$desktop_small_base_height = !empty( $gallery_options['desktop_small_base_height'] ) ? $gallery_options['desktop_small_base_height'] : '300';
