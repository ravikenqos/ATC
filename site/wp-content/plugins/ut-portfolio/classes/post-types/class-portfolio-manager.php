		...
		if ( 0 < count( $field_data ) ) {
			...
			foreach ( $field_data as $k => $v ) {
                ...
                if( $v['type'] == 'showcase_info' ) {
                        ...
                        $html .= '<td>';
                            ...
                            $html .= '<table class="form-table form-table-inner"><tbody>';
                                ...
                                $html .= '<tr valign="top">';
                                    ...
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_text_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_text_color]" id="' . esc_attr( $k ) . '_filter_text_color" /> <label for="' . esc_attr( $k ) . '_filter_text_color"></label>';
                                    $html .= '<p class="description">' . __('Text Color' , 'ut_portfolio_lang') . '</p></td>';
                                    
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_background_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_background_color]" id="' . esc_attr( $k ) . '_filter_background_color" /> <label for="' . esc_attr( $k ) . '_filter_background_color"></label>';
                                    $html .= '<p class="description">' . __('Background Color' , 'ut_portfolio_lang') . '</p></td>';
                                    
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_border_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_border_color]" id="' . esc_attr( $k ) . '_filter_border_color" /> <label for="' . esc_attr( $k ) . '_filter_border_color"></label>';
                        ...
                        $html .= '<td>';
                            ...
                            $html .= '<table class="form-table form-table-inner"><tbody>';
                                ...
                                $html .= '<tr valign="top">';
                                    ...
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_text_hover_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_text_hover_color]" id="' . esc_attr( $k ) . '_filter_text_hover_color" /> <label for="' . esc_attr( $k ) . '_filter_text_hover_color"></label>';
                                    $html .= '<p class="description">' . __('Text Color' , 'ut_portfolio_lang') . '</p></td>';
                                
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_background_hover_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_background_hover_color]" id="' . esc_attr( $k ) . '_filter_background_hover_color" /> <label for="' . esc_attr( $k ) . '_filter_background_hover_color"></label>';
                                    $html .= '<p class="description">' . __('Background Color' , 'ut_portfolio_lang') . '</p></td>';
                                
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_border_hover_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_border_hover_color]" id="' . esc_attr( $k ) . '_filter_border_hover_color" /> <label for="' . esc_attr( $k ) . '_filter_border_hover_color"></label>';
                                    $html .= '<p class="description">' . __('Border Color' , 'ut_portfolio_lang') . '</p></td>';
                        ...
                        $html .= '<td>';
                            ...
                            $html .= '<table class="form-table form-table-inner"><tbody>';
                                ...
                                $html .= '<tr valign="top">';
                                    ...
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_text_selected_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_text_selected_color]" id="' . esc_attr( $k ) . '_filter_text_selected_color" /> <label for="' . esc_attr( $k ) . '_filter_text_selected_color"></label>';
                                    $html .= '<p class="description">' . __('Text Color' , 'ut_portfolio_lang') . '</p></td>';
                                
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_background_selected_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_background_selected_color]" id="' . esc_attr( $k ) . '_filter_background_selected_color" /> <label for="' . esc_attr( $k ) . '_filter_background_selected_color"></label>';
                                    $html .= '<p class="description">' . __('Background Color' , 'ut_portfolio_lang') . '</p></td>';
                                
                                    $html .= '<td><input value="' . $this->validate_value( $data , 'filter_border_selected_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[filter_border_selected_color]" id="' . esc_attr( $k ) . '_filter_border_selected_color" /> <label for="' . esc_attr( $k ) . '_filter_border_selected_color"></label>';
                                    $html .= '<p class="description">' . __('Border Color' , 'ut_portfolio_lang') . '</p></td>';
					...
					$html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Deactivate Filter Border' , 'ut_portfolio_lang') . '</th>';
                        $html .= '<td><select name="' . esc_attr( $k ) . '[filter_deactivate_border]" id="' . esc_attr( $k ) . '_filter_deactivate_border">';
					...
					$html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Filter Text Transform' , 'ut_portfolio_lang') . '</th>';
                        $html .= '<td><select name="' . esc_attr( $k ) . '[filter_text_transform]" id="' . esc_attr( $k ) . '_text_transform">';
