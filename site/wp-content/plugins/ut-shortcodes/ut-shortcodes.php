...
define('UT_SHORTCODES_VERSION', '4.7.1.1');
...
if( defined( 'WPB_VC_VERSION' ) ) {
	...
	require_once( UT_SHORTCODES_DIR . '/vc/vc-bklynicons.php' );
	require_once( UT_SHORTCODES_DIR . '/vc/vc-lineaicons.php' );
	require_once( UT_SHORTCODES_DIR . '/vc/vc-orionicons.php' );
	require_once( UT_SHORTCODES_DIR . '/ut-shortcode-draw-svg.php' );
