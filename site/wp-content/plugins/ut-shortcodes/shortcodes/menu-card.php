    ...
    class UT_Menu_Card_Shortcode {
        ...
        function ut_create_shortcode( $atts ) {
            ...
            if( defined( 'WPB_VC_VERSION' ) ) {                 
                return '<div class="wpb_content_element ' . apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class( $css, ' ' ), $this->shortcode, $atts ) . '">' . do_shortcode( '[ut_menu id="' . esc_attr( $menu_id ) . '"]' ) . '</div>';             
            }  
