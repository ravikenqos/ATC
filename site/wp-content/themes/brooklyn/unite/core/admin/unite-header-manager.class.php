			...
			<div id="ut-ui-admin-header">
                ...
                <div class="grid-90 medium-grid-85 tablet-grid-80 mobile-grid-100 grid-parent">
                    ...
                    <div class="ut-admin-header-title">
                        ...
                        <h1><?php esc_html_e( 'Header Builder.', 'unite-admin' ); ?></h1>
            ...
            <div class="ut-admin-main">
                ...
                <div id="unite-header-manager-form" class="grid-80">
					...
					<ul class="ut-header-builder-tabs clearfix" data-tabgroup="ut_header_builder_group">
						...
						<li><a href="#desktop_header" class="active"><?php esc_html_e( 'Desktop', 'unite-admin' ); ?></a></li>
						<li><a href="#tablet_header"><?php esc_html_e( 'Tablet', 'unite-admin' ); ?></a></li>
						<li><a href="#mobile_header"><?php esc_html_e( 'Mobile', 'unite-admin' ); ?></a></li>
					...
					<section id="ut_header_builder_group" class="ut-header-builder-tabgroup">
						...
						<div id="tablet_header">
							...
							<fieldset>
								...
								<legend><?php esc_html_e('Upper Tablet Header Area', 'unite-admin'); ?><a href="#unite-upper-header-tablet-settings" class="unite-header-section-setting"></a></legend>
							...
							<fieldset>
								...
								<legend><?php esc_html_e('Lower Tablet Header Area', 'unite-admin'); ?><a href="#unite-lower-header-tablet-settings" class="unite-header-section-setting"></a></legend>
						...
						<div id="mobile_header">
							...
							<fieldset>
								...
								<legend><?php esc_html_e('Mobile Header Area', 'unite-admin'); ?><a href="#unite-header-mobile-settings" class="unite-header-section-setting"></a></legend>
                ...
                <div id="unite-header-manager-settings" class="grid-20">
					...
					<h3><?php esc_html_e( 'Settings', 'unite-admin' ); ?></h3>
