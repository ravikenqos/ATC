            ...
            echo '<div class="' . ( in_array( 'padding', $ut_recognized_border_fields ) ? 'grid-30' : 'grid-50' ) . '">';
                ...
                echo '<div class="ut-numeric-slider-outer-wrap">';
                    ...
                    echo '<div class="ut-numeric-slider-wrap">';
                        ...
                        echo '<input autocomplete="off" type="hidden" name="' . esc_attr( $field_name ) . '[border-' . $key . '-width]" id="' . esc_attr( $field_id ) . '-border-' . $key . '-width" class="ut-numeric-slider-hidden-input" value="' . ( isset( $field_value['border-' . $key . '-width'] ) ? esc_attr( $field_value['border-' . $key . '-width'] ) : '' ) . '" data-min="1" data-max="' . esc_attr( $border_max_width ) . '" data-step="1">';
