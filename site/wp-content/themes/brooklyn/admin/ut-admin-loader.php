...
if( !function_exists( '_ut_dashboard_bodyclass' ) ) {
    ...
    function _ut_dashboard_bodyclass( $classes ){
        ...
        if( isset( $_GET['page'] ) && ( $_GET['page'] == 'ut_theme_options' || $_GET['page'] == 'unite-header-manager' || $_GET['page'] == 'ut-demo-importer' || $_GET['page'] == 'ut-demo-importer-reloaded' || $_GET['page'] == 'unite-theme-info' || $_GET['page'] == 'unite-welcome-page' || $_GET['page'] == 'unite-video-tutorials' ) ) {
