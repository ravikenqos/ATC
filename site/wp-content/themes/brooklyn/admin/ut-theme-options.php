        ...
        'settings' => array(
            ...
            */
			...
			array(
                ...
                'required' => array(
                    'ut_header_layout' => 'default',
					'ut_navigation_scroll_position' => 'fixed'
                )
            ),
			...
			array(
                ...
                'label' => 'Animate Navigation Sub Level and Mega Menu Columns?',
			...
			array(
                ...
                'label' => 'Animate Navigation Sub Level and Mega Menu Links on Hover?',
                'desc' => 'Once activated, sub menu level links und mega menu links are getting an additional mouse over animation.',
                'type' => 'select',
                'section' => 'ut_general_settings',
                'subsection' => 'ut_navigation_settings',
                'std' => 'no',
			...
			array(
                ...
                'label' => 'Navigation Sub Level and Mega Menu Link Link Animation Type.',
                'desc' => 'Choose desired animation type.',
                'type' => 'select',
                'section' => 'ut_general_settings',
                'subsection' => 'ut_navigation_settings',
                'std' => 'background',
			...
			array(
                ...
                'label' => 'Navigation Sub Menu Border Top Width',
			...
			array(
                ...
                'label' => 'Navigation Mega Menu Column Border',
                'type' => 'border',
				'markup' => '1_1',
                'section' => 'ut_general_settings',
                'subsection' => 'ut_navigation_settings',
			...
			array(
                ...
                'label' => 'Navigation Sub Menu And Mega Menu Link Animation Color',
                'desc' => 'RGBA Color. <br /><strong>You can also insert a HEX Color, it will be converterted it into a valid RGBA Color automatically.</strong>',
                'type' => 'colorpicker',
                'mode' => 'rgb',
                'section' => 'ut_general_settings',
			...
			array(
                ...
                'label' => 'Navigation Megamenu Column Title Color',
                'desc' => 'RGBA Color. <br /><strong>You can also insert a HEX Color, it will be converterted it into a valid RGBA Color automatically.</strong>',
                'type' => 'colorpicker',
                'mode' => 'rgb',
                'section' => 'ut_general_settings',
			...
			array(
                ...
                'label' => 'Navigation Megamenu Column Title Hover Color',
                'desc' => 'RGBA Color. <br /><strong>You can also insert a HEX Color, it will be converterted it into a valid RGBA Color automatically.</strong>',
                'type' => 'colorpicker',
                'mode' => 'rgb',
                'section' => 'ut_general_settings',
			...
			array(
                'id' => 'ut_navigation_ss_sl_border_width',
                'label' => 'Navigation Sub Menu Border Top Width',
                'desc' => 'Drag the handle to set the border width value.',
                'type' => 'numeric-slider',
                'section' => 'ut_general_settings',
			...
			array(
                ...
                'label' => 'Navigation Megamenu Column Title Color Hover',
                'desc' => 'RGBA Color. <br /><strong>You can also insert a HEX Color, it will be converterted it into a valid RGBA Color automatically.</strong>',
                'type' => 'colorpicker',
                'mode' => 'rgb',
                'section' => 'ut_general_settings',
            ...
            */
			...
			array(
                ...
                'label' => 'Text Logo Color ( opened mobile nav )',
                'desc' => 'RGBA Color. <br /><strong>You can also insert a HEX Color, it will be converterted it into a valid RGBA Color automatically.</strong>',
                'type' => 'colorpicker',
                'mode' => 'rgb',
                'section' => 'ut_general_settings',
