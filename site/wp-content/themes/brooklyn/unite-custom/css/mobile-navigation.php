        ...
        public function custom_css() {
            ...
            <style id="ut-mobile-navigation-custom-css" type="text/css">
                ...
                @media (max-width: 1024px) {
					...
					<?php if( ot_get_option( 'ut_mobile_navigation_text_logo_color' ) ) : ?>
						...
						#ut-sitebody.ut-mobile-menu-open #header-section.ha-header .site-logo h1.logo a:hover {
                            color: <?php echo ot_get_option( 'ut_mobile_navigation_text_logo_color' ); ?> !important; 
                        }
				...
				<?php if( ot_get_option('ut_mobile_navigation_trigger_icon_type', 'hamburger') == 'hamburger' ) : ?>
                ...
                <?php if( ut_return_header_config('ut_navigation_scroll_position' , 'floating') == 'fixed' && ut_return_header_config( 'ut_navigation_on_hero', 'off' ) == 'off' ) : ?>
