    ...
    class UT_Hero_CSS extends UT_Custom_CSS {
        ...
        public function custom_css() {
            ...
            <style id="ut-hero-custom-css" type="text/css">
                ...
                if( $ut_hero_type == 'image' || $ut_hero_type == 'video' || $ut_hero_type == 'animatedimage' || $ut_hero_type == 'splithero' || $ut_hero_type == 'imagefader' ) :
				...
				$ut_hero_background_color = ut_return_hero_config('ut_hero_background_color', ot_get_option('ut_global_hero_background_color', '#141618') );
				...
				if( ut_return_header_config( 'ut_header_layout', 'default' ) != 'side' ) {
					...
					if( ut_return_header_config('ut_navigation_scroll_position' , 'floating') == 'floating' && ut_return_header_config( 'ut_navigation_skin' , 'ut-header-light' ) == 'ut-header-custom' && ut_return_header_config( 'ut_header_ps_background_color' ) == 'transparent' &&  ut_return_hero_config( 'ut_hero_height','100' ) == '100' ) {
						
						echo '#ut-hero:not(.slider) .hero-holder { padding-top:0; }';
						
					}
					
					if( ut_return_header_config('ut_navigation_scroll_position' , 'floating') == 'fixed' && ut_return_header_config( 'ut_navigation_on_hero', 'off' ) == 'on' && ut_return_header_config( 'ut_navigation_skin' , 'ut-header-light' ) == 'ut-header-custom' && ut_return_header_config( 'ut_header_ps_background_color' ) == 'transparent' &&  ut_return_hero_config( 'ut_hero_height','100' ) == '100' ) {
