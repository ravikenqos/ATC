        ...
        if( is_single() ) {
			...
			if( $ut_hero_type == 'image' || $ut_hero_type == 'splithero' || $ut_hero_type == 'tabs' ) {
				...
				if( is_array( $ut_hero_image ) && !empty( $ut_hero_image['background-image'] ) ) {
					...
					$open_graph_imgage = $ut_hero_image['background-image'];

				} elseif( !empty( $ut_hero_image ) && !is_array( $ut_hero_image ) ) {

					$open_graph_imgage = $ut_hero_image;
			...
			if( $ut_hero_type == 'video' )  {
				...
				$open_graph_imgage = ut_return_hero_config('ut_video_poster');
			...
			if( $ut_hero_type == 'animatedimage' )  {
				...
				$open_graph_imgage = ut_return_hero_config('ut_hero_animated_image');
            ...
            if( $open_graph_imgage ) {
                $open_graph .= '<meta property="og:image" content="' . esc_url( $open_graph_imgage ) . '" />'. "\n";
            }
