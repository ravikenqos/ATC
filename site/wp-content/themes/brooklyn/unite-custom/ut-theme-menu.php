...
if ( ! function_exists( '_ut_megamenu_js_translation' ) ) :
    ...
    function _ut_megamenu_js_translation( $strings ) {
		...
		$strings['megamenu_image_added_message']    = sprintf( esc_html__( 'Do not forget to make %1$s a child of %2$s', 'unite' ), '<span class="ut-is-megamenu-image">' . esc_html__( 'Image', 'unite' ) . '</span>', '<span class="ut-is-megamenu">' . esc_html__( 'Megamenu', 'unite' ) . '</span>');
